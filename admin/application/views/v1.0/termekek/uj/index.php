				...
				<div class="con">
					...
					<div class="row">
						...
						<div class="form-group col-md-3">
							...
							<input type="text" class="form-control" name="mertekegyseg" id="mertekegyseg" value="<?=($this->err) ? $_POST['mertekegyseg'] : ''?>">
						</div>
						<div class="form-group col-md-3">
							<label for="mertekegyseg_ertek">Mértékegység érték</label>
							<input type="text" class="form-control" name="mertekegyseg_ertek" id="mertekegyseg_ertek" value="<?=($this->err) ? $_POST['mertekegyseg_ertek'] : ''?>">
						</div>
						<?php if (false): ?>
							<div class="form-group col-md-2">
